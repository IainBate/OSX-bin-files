...
def process(files, dest, verbose):
	...
	# multiple lines:
	cmd = """ffmpeg -y -i %s -vcodec libx264 -vpre max -threads 0 -b 3000k -ab 128k -pass 1 %s; ffmpeg -y -i %s -vcodec libx264 -vpre max -threads 0 -b 3000k -ab 128k -pass 2 %s; rm *.log"""
