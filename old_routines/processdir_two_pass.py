...
def process(files, dest, verbose):
	...
	# multiple lines:
	cmd = """nice -n 20 ffmpeg -y -i %s -vcodec libx264 -vpre default -threads 0 -b 3000k -ab 128k -pass 1 %s; nice -n 20 ffmpeg -y -i %s -vcodec libx264 -vpre default -threads 0 -b 3000k -ab 128k -pass 2 %s; rm *.log"""
